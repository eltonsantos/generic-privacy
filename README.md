...
Este repositório contém a página estática da **Política de Privacidade**.

## Como publicar no GitHub Pages
1. Crie um repositório (público) chamado, por exemplo, `generic-privacy`.
2. Faça commit do arquivo `index.html` na raiz do repositório.
3. No GitHub, acesse *Settings → Pages*:
   - **Source**: `Deploy from a branch`
   - **Branch**: `main` (pasta `/root`)
4. A URL será algo como `https://<seu-usuario>.github.io/generic-privacy/`.
...
## Dados rápidos
- Última atualização: 01/31/2026
- Contato: suporte@generic-privacy.com
